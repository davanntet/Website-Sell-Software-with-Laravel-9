        ...
        <div class="overflow-auto lg:overflow-visible ">
            ...
            <table class="table text-gray-400 border-separate space-y-6 text-sm">
                ...
                <tr class="">
                    ...
                    <th class="p-3 text-left w-56">Category</th>
                    <th class="p-3 text-left w-56">Image</th>
                    <th class="p-3 text-left w-56">Price</th>
                ...
                <tr class="bg-blue-200">
                    ...
                    <td class="p-3 text-blue-600 font-bold">
                       ...
                       <td class="p-3 text-blue-600 font-bold">
                        ...
                        <td class="p-3 text-blue-600 font-bold">
                        <div>{!! Html::image("/img/".$product->image, $product->name, array('width'=>'20')) !!}</div>
                    </td>
                        </td>
                        <td class="p-3 text-blue-600 font-bold">
                        {{$product->price}}
                    ...
                    <td class="p-3 ">
                        ...
                        <a href="{{url('/product/'.$product->id)}}" class="text-gray-500 hover:text-gray-100 mr-2">
                            <i class="material-icons-outlined text-base ">visibility</i>
                        </a>
                        <a href="{{url('/product/'.$product->id.'/edit') }}" class="text-gray-500 hover:text-gray-100  mx-2">
