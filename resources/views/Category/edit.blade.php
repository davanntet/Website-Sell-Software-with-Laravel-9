 ...
 <div class="flex justify-center items-center h-screen">
        <div class="w-96 p-6 shadow-lg bg-white rounded-md">
           ...
           <label for="password" class="block text-base mb-2">Description about category</label>
			{!! Form::textarea('description',null,array('class'=>'dh-area border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="please decription about category')) !!}		
            </div>
            <div class="mt-3">
